...
class Generator:
    ...
    def generate_response(self, context: str, doc_ids: List[str] = None, history: List[Dict] = None, machine_context: Dict = None) -> Dict:
        ...
        response = self._generate_with_context(context, context_text, history, machine_context)
    ...
    def _generate_with_context(self, query: str, context_text: str, history=None, machine_context=None) -> str:
        """Generate a response using the LLM with context, history, and machine context."""
        history_text = ""
        ...
        # Include machine context if provided
        machine_context_text = ""
        if machine_context:
            machine_context_text = "MACHINE INFORMATION:\n"
            machine_context_text += f"Machine Type: {machine_context.get('machineType', 'Unknown')}\n"
            machine_context_text += f"Transmission Type: {machine_context.get('transmissionType', 'Unknown')}\n\n"
        ...
        6. If the user is asking about a specific machine type or transmission type, tailor your response to that specific configuration
